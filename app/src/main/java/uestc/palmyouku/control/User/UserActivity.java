package uestc.palmyouku.control.User;
...
public class UserActivity extends Activity implements View.OnClickListener {
	Button btn_player, btn_login, btn_logout, btn_state, btn_downloaded_video,
			btn_downloading_video;
	EditText et;
	...
	private void init() {
		...
		btn_downloading_video = (Button) this
				.findViewById(R.id.btn_downloading); // 进入正在下载视频的展示界面
	...
	private void go2Player() {
		Intent i = new Intent(UserActivity.this, PlayerActivity.class);
	...
	private void doLogin() {
		...
		YoukuLoginOperator.showLoginView(this);
	}
